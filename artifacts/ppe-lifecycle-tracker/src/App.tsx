...
import {
  DEFAULT_RULES, SOURCE_ACTIVITIES, cloneSource, ensureRequiredAssignments, mergeRulesWithDefaults, ruleName, type Activity, type AssignmentStatus, type Employee,
